(ns top.kzre.krro.plugin.painting.core.command.layer
  (:require
    [top.kzre.krro.core.command :as cmd]
    [top.kzre.krro.core.frame :as frame]
    [top.kzre.krro.plugin.painting.core.ops.layer :as layer] ;; 基础函数
    [top.kzre.krro.plugin.painting.core.ops.layer-undo :as layer-undo] ;; 带撤销的函数
